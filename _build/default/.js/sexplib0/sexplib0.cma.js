   ...
   {"use strict";
    ...
    function compare$0(a$0,match)
     {if(a$0 === match)return 0;
      if(0 === a$0[0])
       {var _cc_=a$0[1];
        if(0 === match[0])
         {var b$0=match[1];return caml_call2(Stdlib_stringLabels[5],_cc_,b$0)}
        return -1}
      var _cd_=a$0[1];
       ...
       {var i=_bV_;
        for(;;)
         {var c=caml_string_unsafe_get(s,i),switch$2=0;
          ...
          break}}
      return caml_call1(Stdlib_bytesLabels[42],s$0)}
    function esc_str(str)
     {var
      ...
      return caml_call1(Stdlib_bytesLabels[42],dst)}
    function index_of_newline(str,start)
     {try
       {var _bR_=[0,caml_call3(Stdlib_stringLabels[21],str,start,10)];
        return _bR_}
      catch(_bS_)
          ...
          for(;;)
           {var end_pos_opt=index_of_newline(str,index$0);
            ...
            var
             next_line=
              caml_call3
               (Stdlib_stringLabels[9],str,index$0,end_pos$0 - index$0 | 0),
    ...
    function to_buffer_hum(buf,opt,sexp)
     {if(opt)var sth=opt[1],indent=sth;else var indent=default_indent[1];
      ...
      return caml_call4(Stdlib_format[126],ppf,_b_,_bH_,sexp)}
    ...
    function record_superfluous_fields(what,loc,rev_fld_names,sexp)
     {var
       ...
       fld_names_str=caml_call2(Stdlib_stringLabels[3],cst$12,_aR_),
     ...
     {var fields$0=fields,param$0=param;
      for(;;)
       {if(param$0)
        ...
        return caml_call2(Stdlib_stringLabels[3],cst$13,_aQ_)}}
